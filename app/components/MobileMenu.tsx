...
export default function MobileMenu({ name, signOutAction }: MobileMenuProps) {
  ...
  return (
    <div ref={ref}>
      ...
      <nav
        className={`fixed top-14 bottom-0 w-[65%] bg-white border-r border-zinc-200 shadow-2xl flex flex-col gap-4 px-4 py-4 transition-all duration-300 ${open ? "left-0 opacity-100" : "-left-1/2 opacity-0 pointer-events-none"}`}
      >
